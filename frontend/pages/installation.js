        ...
        <div className="container flex flex-col  ">
            {data?.map(({ id, attributes }) => (
                ...
                <div className="flex flex-1 text-lg" key={id}>
                    ...
                    <div className="">
                        <h3 className="font-bold mt-4 mb-4">{attributes.product}<span className="text-primary-700 border-dotted border-indigo-800 border-l-3">{attributes.version}</span></h3>
