  ...
  return (
    <div className="container flex flex-col items-center mt-4">
      ...
      <div className="prose-xl prose-pink lg:prose-lg prose-table:table-auto  prose-table:border-separate prose-img:rounded-xl prose-em:text-center prose-figcaption:text-center py-12 flex flex-col  ">
        <Markdown className="prose-xl lg:prose-lg prose-headings:text-orange-600 prose-headings:prose-headings prose-h1:text-center prose-h3:text-center prose-h2:text-center prose-th:border prose-td:border prose-table:text-center prose-table:table-auto prose " remarkPlugins={[remarkGfm, remarkImages]}>
          {data.content}
        </Markdown>
        {data.media?.data?.map(e => (<div className="flex-shrink-0 w-full mt-6 md:mt-0">
