        ...
        <div className="relative" 
         ...
         >
            <div className="absolute h-full w-full backdrop-blur-sm">
                <NextImage media={data.backgroundImage} layout="fill"  className="-z-10 object-cover backdrop-blur-sm" />
            </div>
            <section className="container py-20 relative">
            <div className=" flex flex-col " >
                <Markdown className={classNames("prose py-3 text-center prose-headings:underline prose-p:py-3 self-center",
                 {"prose-invert": data.isDark})}>
                {data.richtext}
                </Markdown>
                <div className="self-center inline-flex gap-4">
                    {data.links?.map(link => (
                        <ButtonLink className="" appearance={getButtonAppearance(link.type, "white")} compact button={link} />
            ...
            <div className="flex mx-12 py-4 flex-col flex-wrap md:flex-row md:gap-12 md:justify-center mt-6">
              ...
              100vw"
                        ...
                        <h2 className="text-xl font-bold break-normal text-neutral-600">{learning.title}</h2>
