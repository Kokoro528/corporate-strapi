...
var _excluded = ["index", "isActive", "selectBar", "onClick"];
var SelectBarWrapper = styled.li.attrs(function (props) {
  return {
    className: props.selectBarItemWrapperClassName
  };
}).withConfig({
  displayName: "SelectBar__SelectBarWrapper",
  componentId: "sc-ss4ufg-0"
})(["display:flex;margin:0 5px;cursor:pointer;"]);

var SelectBar = function SelectBar(_ref) {
  var index = _ref.index,
      _ref$isActive = _ref.isActive,
      isActive = _ref$isActive === void 0 ? false : _ref$isActive,
      SelectCustom = _ref.selectBar,
  ...
  return /*#__PURE__*/React__default.createElement(SelectBarWrapper, _extends({
    onClick: handleClick
  }, rest), SelectCustom ? /*#__PURE__*/React__default.createElement(SelectCustom, {
    isActive: isActive,
    index: index
  }) : /*#__PURE__*/React__default.createElement("span", null, index));
};

SelectBar.propTypes = {
  index: PropTypes.number.isRequired,
  isActive: PropTypes.bool,
  selectBar: PropTypes.oneOfType([PropTypes.node, PropTypes.element, PropTypes.elementType]),
  onClick: PropTypes.func.isRequired,
...
var SelectBars = styled.ul.attrs(function (props) {
  return {
    className: props.selectBarClassName
  };
}).withConfig({
  displayName: "Carousel__SelectBars",
  componentId: "sc-1noofmr-4"
})(["position:relative;display:flex;align-items:center;justify-content:center;"]);
var Dots = styled.div.withConfig({
  displayName: "Carousel__Dots",
  componentId: "sc-1noofmr-5"
...
var Carousel = function Carousel(_ref20) {
  var _ref20$cols = _ref20.cols,
      ...
      _ref20$showSelectBar = _ref20.showSelectBar,
      showSelectBar = _ref20$showSelectBar === void 0 ? false : _ref20$showSelectBar,
      selectBar = _ref20.selectBar,
      selectBarClassName = _ref20.selectBarClassName,
      selectBarItemWrapperClassName = _ref20.selectBarItemWrapperClassName,
  ...
  return /*#__PURE__*/React__default.createElement(Container, {
    ...
    CustomBtn: arrowLeft,
    onClick: handlePrev
  }), showSelectBar && /*#__PURE__*/React__default.createElement(SelectBars, {
    mobileBreakpoint: mobileBreakpoint,
    className: selectBarClassName
  }, _toConsumableArray(Array(page)).map(function (_, i) {
    return /*#__PURE__*/React__default.createElement(SelectBar, {
      key: i,
      index: i,
